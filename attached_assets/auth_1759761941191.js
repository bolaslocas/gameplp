...
// INSTRUCCIONES: Reemplaza esta configuración con tu proyecto de Firebase
...
const SESSION_DURATION = 5 * 24 * 60 * 60 * 1000 // 5 días
...
window.PoolAuth = {
  ...
  clearSession,
  checkFirebaseAuth,
  // Exponer Firebase auth para uso avanzado
  getAuth: () => auth,
